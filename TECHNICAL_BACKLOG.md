...
4 ADR Candidates (ADR-C2 **closed**) · 5 Operational Risks · 6 Testing Gaps · **7 Runtime Verification
Required (RV-1…RV-7)**. Обновлено после Этапа 8: добавлен RV-7 (queue-runtime, живые PG+Redis). Ни
один не блокирует следующий этап. Реализуются строго на указанных этапах и/или по
